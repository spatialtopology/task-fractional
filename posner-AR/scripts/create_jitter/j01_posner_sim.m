...
diaryname = sprintf(['/Users/h/Documents/projects_local/fractional_factorials/posner-AR/design/s03_jitter/posner_Events_best_design_of_10000_ver-', num2str(ver,'%03.f'), '.txt'] );
diary(diaryname)
print_matrix(best_design_struct.eventlist, best_design_struct.eventlist_names);
diary off

diaryname = sprintf(['/Users/h/Documents/projects_local/fractional_factorials/posner-AR/design/s03_jitter/posner_Events_best_design_of_10000_under_ideal_length_sec_ver-', num2str(ver,'%03.f'),'.txt'] );
diary(diaryname)
